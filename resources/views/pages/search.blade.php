                  ...
                  <div class="col-md-6 d-none d-md-block">
                     <div class="card mb-2 rounded-post border-0 shadow-sm">
                        <div class="img-photo-post">
                           <img src="{{ url(Storage::url($item->thumbnail))}}" class="card-img-top"
                              alt="{{ $item->slug }}" loading="lazy" class="lazyload">
                        </div>
                        <div class="px-3 py-3">
                           <a href="{{ route('detail',$item->slug) }}"
                              class="text-judul-post text-justify">{{ $item->title }}</a>
                           ...
                           <table class="table table-borderless">
                              ...
                              <tr>
                                 ...
                                 <td class="text-right tanggal-posting">
                                    {{ date_format($item->created_at,"d F Y")}}</td>
                              </tr>
                              <tr>
               ...
               <div class="card border-0 shadow-sm rounded-post p-3 mb-4">
                  ...
                  <div class="row">
                     ...
                     {{-- @foreach ($popular as $item)
                        <div class="col-sm-12 col-md-6 col-lg-12">
                           <div class="media mt-2">
                              <img src="{{ Storage::url($item->thumbnail) }}{{ url('themes/frontend/assets/image/constant-loubier-7lzIyp2Ork4-unsplash.jpg')}}"
                     width="100" height="60" class="rounded-post align-self-center rounded-trending-img mr-3">
                     <div class="media-body">
         ...
         <div class="card border-0 shadow-sm rounded-post p-3 mb-4">
            ...
            <div class="label-post">
               ...
               <a href="{{ route('category', $item->slug) }}"
                  class="btn {{ $color}} btn-kategori text-decoration-none mb-2">{{$item->name}}</a>
               @endforeach
            </div>
         </div>
      </div>
