  ...
  <div class="row">
    ...
    {{-- <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">4574</div>
              </div>
              <div class="col-auto">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
              <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Categori</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $categori }}</div>
              </div>
              <div class="col-auto">
